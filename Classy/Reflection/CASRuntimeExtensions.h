...
typedef enum {
     ...
     */
    cas_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    cas_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    cas_propertyMemoryManagementPolicyCopy
} cas_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #cas_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    cas_propertyMemoryManagementPolicy memoryManagementPolicy;
