//
//  MODRuntimeExtensions.h
//  Mod
//
//  Created by Jonas Budelmann on 14/10/13.
//  Renamespaced version of EXTRuntimeExtensions
//
...
typedef enum {
     ...
     */
    mod_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    mod_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    mod_propertyMemoryManagementPolicyCopy
} mod_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #mod_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    mod_propertyMemoryManagementPolicy memoryManagementPolicy;
 ...
 */
mod_propertyAttributes *mod_copyPropertyAttributes (objc_property_t property);
